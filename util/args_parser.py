...
def args_parser():
    ...
    parser.add_argument(
        "--resamp_with_conv", action="store_false", default=True, help="always up/down sampling with conv"
    )
    ...
    parser.add_argument(
        "--progressive_combine", type=str, default="sum", choices=["sum", "cat"], help="progressive combine method."
    )
    ...
    parser.add_argument(
        "--schedule", type=int, default=1800, help="cosine scheduler, learning rate 1e-5 until {schedule} epoch"
    )
